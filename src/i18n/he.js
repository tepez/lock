export default {
  error: {
    ...
    signUp: {
      invalid_password: 'הסיסמה אינה תקינה.',
      'lock.fallback': 'אנו מתנצלים, משהו השתבש בעת נסיון ההרשמה.',
      password_dictionary_error: 'הסיסמה נפוצה מדי.',
      password_no_user_info_error: 'הסיסמה מבוססת על פרטי המשתמש שלך.',
      password_strength_error: 'הסיסה חלשה מדי.',
      user_exists: 'המשתמש כבר קיים במערכת.',
      username_exists: 'שם המשתמש הזה כבר קיים במערכת.'
    }
  },
  success: {
  ...
  mfaLoginTitle: 'זיהוי ב-2 שלבים',
  mfaLoginInstructions: 'יש להכניס את קוד האימות שנוצר ע"י האפליקציה.',
  mfaSubmitLabel: 'התחבר',
  mfaCodeErrorHint: 'יש להכניס %d ספרות'
};
